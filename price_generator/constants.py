...
SALES_ANALYSIS_CACHE_FILE_NAME = "sales_analysis_cache.json"
INTERNAL_ORDER_NUMBER_COLUMN_NAME = "内部订单号"
ORDER_WEIGHT_COLUMN_NAME = "订单重量"
SALES_AMOUNT_COLUMN_NAME = "销售金额"
SALES_COST_COLUMN_NAME = "销售成本"
